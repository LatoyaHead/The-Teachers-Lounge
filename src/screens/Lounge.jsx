...
const Lounge = ({loggedInUser}) => {
  return (
    ...
    {lounges.map((lounge) => (
      <div className="card">
        <div style={{ padding:'8px', width: '100%', background: 'black', display: 'flex', justifyContent: 'center', alignItems: 'center', boxSizing:'border-box'}}>
            <div style={{width: "100%", display: 'flex', flexDirection: "row", alignItems:"center", gap:'10px'}}>
              <img src={lounge.avatar} alt="users avatar" style={{borderRadius:"50%", height:'65px'}}/>
